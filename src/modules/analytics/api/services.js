...
export const reportingApi = {
  ...
  scheduledReports: () => api.get('/api/reporting/scheduled-reports'),
  createScheduledReport: (data) => api.post('/api/reporting/scheduled-reports', data),
  deleteScheduledReport: (id) => api.delete(`/api/reporting/scheduled-reports/${id}`),
  runScheduledReport: (id) => api.post(`/api/reporting/scheduled-reports/${id}/run`, {}),
  lotLedger: (id) => api.get(`/api/reporting/lot-ledger/${id}`),
  batchLedger: (id) => api.get(`/api/reporting/batch-ledger/${id}`),
  supplierInventoryIndex: () => api.get('/api/reporting/supplier-ledger'),
  supplierLedger: (id) => api.get(`/api/reporting/supplier-ledger/${id}`),
  riceTypeIndex: () => api.get('/api/reporting/rice-type-ledger'),
  ...
  serviceMillingStock: (params) => api.get('/api/reporting/service-milling-stock', params),
  serviceMillingAgeing: () => api.get('/api/reporting/service-milling-ageing'),
  serviceMillingPendingDispatch: () => api.get('/api/reporting/service-milling-pending-dispatch'),
  serviceMillingReconciliation: () => api.get('/api/reporting/service-milling-reconciliation'),
  lotTracker: (params) => api.get('/api/reporting/lot-tracker', params),
  salesTracker: (params) => api.get('/api/reporting/sales-tracker', params),
