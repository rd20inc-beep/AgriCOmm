...
const STATUS_TONE = { Paid: 'bg-emerald-100 text-emerald-700', Partial: 'bg-amber-100 text-amber-700', Unpaid: 'bg-rose-100 text-rose-700', Pending: 'bg-rose-100 text-rose-700' };
...
export default function PurchaseInvoiceView() {
  ...
  if (isError || !data?.purchase) return (
    <div className="p-6">
      ...
      <p className="mt-4 text-sm text-rose-600">{error?.message || 'Purchase invoice not available for this lot.'}</p>
    </div>
  );
