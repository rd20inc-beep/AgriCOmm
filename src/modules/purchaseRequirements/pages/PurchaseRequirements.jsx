...
// Purchase Requirements (Phase 3). Packing/material shortages → request → Mill/Owner
// approves → Finance gets a MASKED request. The API redacts customer/order/stock
// context for the Finance Manager; this page just renders whatever it's given.
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">{masked ? 'Approved material purchase requests awaiting payment.' : 'Material shortages requiring purchase — approve to send to Finance.'}</p>
        </div>
