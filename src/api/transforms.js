 ...
 *  Outflows on export orders are always PKR (business rule, see migration
 *  079) so we sum amounts as-is — no FX conversion. */
...
export function transformBatch(dbBatch) {
  ...
  return {
    ...
    rawQtyKg: parseFloat(dbBatch.raw_qty_kg) || 0,
    plannedFinishedKg: parseFloat(dbBatch.planned_finished_kg) || 0,
    actualFinishedKg: parseFloat(dbBatch.actual_finished_kg) || 0,
    finishedConsumedKg: parseFloat(dbBatch.finished_consumed_kg) || 0,
    brokenKg: parseFloat(dbBatch.broken_kg) || 0,
    b1Kg: parseFloat(dbBatch.b1_kg) || 0,
    b2Kg: parseFloat(dbBatch.b2_kg) || 0,
    b3Kg: parseFloat(dbBatch.b3_kg) || 0,
    csrKg: parseFloat(dbBatch.csr_kg) || 0,
    shortGrainKg: parseFloat(dbBatch.short_grain_kg) || 0,
    powderKg: parseFloat(dbBatch.powder_kg) || 0,
    sweepingKg: parseFloat(dbBatch.sweeping_kg) || 0,
    chobaKg: parseFloat(dbBatch.choba_kg) || 0,
    ovKg: parseFloat(dbBatch.ov_kg) || 0,
    stoneKg: parseFloat(dbBatch.stone_kg) || 0,
    sortexRejectsKg: parseFloat(dbBatch.sortex_rejects_kg) || 0,
    wastageKg: parseFloat(dbBatch.wastage_kg) || 0,
    finishedPricePerKg: parseFloat(dbBatch.finished_price_per_kg) || 0,
    brokenPricePerKg: parseFloat(dbBatch.broken_price_per_kg) || 0,
    b1PricePerKg: parseFloat(dbBatch.b1_price_per_kg) || 0,
    b2PricePerKg: parseFloat(dbBatch.b2_price_per_kg) || 0,
    b3PricePerKg: parseFloat(dbBatch.b3_price_per_kg) || 0,
    csrPricePerKg: parseFloat(dbBatch.csr_price_per_kg) || 0,
    shortGrainPricePerKg: parseFloat(dbBatch.short_grain_price_per_kg) || 0,
    powderPricePerKg: parseFloat(dbBatch.powder_price_per_kg) || 0,
    sweepingPricePerKg: parseFloat(dbBatch.sweeping_price_per_kg) || 0,
    chobaPricePerKg: parseFloat(dbBatch.choba_price_per_kg) || 0,
    sortexRejectsPricePerKg: parseFloat(dbBatch.sortex_rejects_price_per_kg) || 0,
