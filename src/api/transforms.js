...
export function transformBatch(dbBatch) {
  ...
  return {
    ...
    chobaMT: parseFloat(dbBatch.choba_mt) || 0,
    ovMT: parseFloat(dbBatch.ov_mt) || 0,
    stoneMT: parseFloat(dbBatch.stone_mt) || 0,
    ...
    powderPricePerMT: parseFloat(dbBatch.powder_price_per_mt) || 0,
    sweepingPricePerMT: parseFloat(dbBatch.sweeping_price_per_mt) || 0,
    chobaPricePerMT: parseFloat(dbBatch.choba_price_per_mt) || 0,
