...
export const CAT_ORDER = ['Finished Rice', 'B1', 'B2', 'B3', 'CSR', 'Short Grain', 'Broken', 'Powder', 'Sweeping', 'Choba', 'Bran', 'Husk', 'Sortex', 'Raw Rice', 'Packaging', 'Other'];
...
export const CAT_COLOR = {
  ...
  Choba: 'bg-teal-100 text-teal-700',
